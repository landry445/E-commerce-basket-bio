    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
      <div className="bg-white rounded-xl p-8 shadow-xl min-w-[320px] text-center">
        ...
        <div className="flex gap-4 justify-center">
          <button
            className="px-4 py-2 rounded-full bg-green-100 text-green-700 hover:bg-green-200 font-bold"
            onClick={onCancel}
          >
            Annuler
          </button>
          <button
            className="px-4 py-2 rounded-full bg-red-600 text-white hover:bg-red-700 font-bold"
            onClick={onConfirm}
          >
            Supprimer
          </button>
